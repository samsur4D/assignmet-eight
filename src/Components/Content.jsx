...
const readArray = JSON.parse(localStorage.getItem("readList"))
...
<>
       ...
       {readArray.map((book)=>(
         <div key={book.bookId} className="flex flex-col gap-5 container mt-10">
           
        
         <div className="relative flex flex-col mr-24 rounded-xl container mx-auto bg-green-400 px-10 py-2 divide-y xl:flex-row xl:divide-y-0 xl:divide-x dark:bg-gray-50 dark:text-gray-800 dark:divide-gray-300">
         ...
         <button>Tag</button>
         <button className="bg-blue-500 px-4 py-2 rounded-3xl text-white font-bold">{book.tags[0]}</button>
         <button className="bg-blue-500 px-4 py-2 rounded-3xl text-white font-bold">{book.tags[1]}</button>
         </div>
         ...
         <h2 className="flex items-center gap-2"><LiaUserFriendsSolid className="text-3xl"/>Publisher :{book.publisher} </h2>
         </div>
         <div className="flex items-center">
         <h2 className="flex items-center gap-2"><MdInsertPageBreak className="text-3xl"/>Pages : {book.totalPages} pages </h2>
         </div>
         </div>
         <hr />
